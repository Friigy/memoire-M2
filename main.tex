...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \HRule \\[0.4cm]
    { \huge \bfseries Générer la meilleur équipe pokémon pour les VGC 2019\\[0.4cm] }
...
Merci maman, merci papa, merci nintendo et merci la dépression
...
Le pouvoir de l'amitié qui triomphe toujours
