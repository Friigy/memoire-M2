...
De manière officiel, il existe pour le jeu vidéo la compétitions des VGC et pour le jeu de cartes à collectionner, il existe les TCG Championship. Ces compétitions se déroule sur les trois jours qui lui sont dédier par an nommé les Pokemon Worlds. Chaque année, pour y participer en tant que compétiteur, il faut participer à des tournois durant le cours de l'année pour accumuler un certain nombre de point.